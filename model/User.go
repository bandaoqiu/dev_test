...
type User struct {
	gorm.Model
	FirstName string `json:"first_name" binding:"required,min=64" gorm:"column:first_name;type:varchar(255);not null;"`
	LastName  string `json:"last_name" binding:"required,min=64" gorm:"column:last_name;type:varchar(255);not null"`
